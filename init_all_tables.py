...
# ─────────────────────────────────────────────
# INICIALIZAR + MIGRAR (función combinada)
# ─────────────────────────────────────────────
def init_and_migrate():
    """
    Llama primero a init_all_tables() para crear tablas nuevas,
    luego a run_migrations() para arreglar columnas en tablas existentes.
    Úsala en web.py en lugar de init_all_tables() para cubrirlo todo.
    """
    init_all_tables()
    try:
        ...
        logger.warning(f"⚠️ migrate_railway no disponible: {e}")
